...
namespace FancyScrollView.Example08
{
    public class Example08 : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //GenerateCells(filterCategories.filteredProducts.Count);
            //gridView.JumpTo(50);
        }
        ...
        void SelectCell()
        {
            ...
            //{
                ...
                gridView.ScrollTo(0, 0.4f, Ease.InOutQuint, Alignment.Upper);
            //});
        }
        ...
        public void GenerateCells(int dataCount)
        {
            var items = Enumerable.Range(0, dataCount)
                .Select(i => new ItemData(filterCategories.filteredProducts[i].name))
                .ToArray();
